...
void CSkeletonX::_Render(CBackend& cmd_list, ref_geom& hGeom, u32 vCount, u32 iOffset, u32 pCount)
{
    ...
    case RM_SINGLE_HQ:
    {
        if (RMS_boneid < Parent->LL_BoneCount())
        {
            Fmatrix W;
        ...
        if (array)
        {
            ...
            if (array_ptr)
            {
                ...
                for (u32 mid = 0; mid < count; mid++)
                {
                    ...
                    u32 id = mid * 3;
                    cmd_list.set_ca(array_ptr, id + 0, M._11, M._21, M._31, M._41);
                    cmd_list.set_ca(array_ptr, id + 1, M._12, M._22, M._32, M._42);
                    cmd_list.set_ca(array_ptr, id + 2, M._13, M._23, M._33, M._43);
                }
            }
        }
