...
public:
    ...
    virtual void Execute(LPCSTR args)
    {
        ...
        bool exist = CSavedGameWrapper::saved_game_exist(saved_game);
        ...
        */
        ...
        if (MainMenu()->IsActive())
        {
            Msg(">>> [CCC_ALifeLoadFrom] Deactivating MainMenu...");
            MainMenu()->Activate(false);
        }
...
public:
    ...
    virtual void Execute(LPCSTR args)
    {
        ...
        bool exist = CSavedGameWrapper::saved_game_exist(g_last_saved_game);
