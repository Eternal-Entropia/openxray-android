...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "1.23.1"
  WORKING_DIRECTORY "C:/oxr_deps/openal-soft-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/oxr_deps/openal-soft-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/oxr_deps/openal-soft-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
