...
if (TARGET theora OR TARGET Theora::Theora)
    set(THEORA_FOUND TRUE)
    if (TARGET theora AND NOT TARGET Theora::Theora)
        add_library(Theora::Theora ALIAS theora)
    endif()
    if (TARGET theoradec AND NOT TARGET Theora::TheoraDec)
        add_library(Theora::TheoraDec ALIAS theoradec)
    endif()
    if (TARGET theoraenc AND NOT TARGET Theora::TheoraEnc)
        add_library(Theora::TheoraEnc ALIAS theoraenc)
    endif()
    return()
endif()
#.rst:
